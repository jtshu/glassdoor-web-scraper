...
def chatgpt_rephrase(question: str) -> str:
    os.environ["OPENAI_API_KEY"] = "" # Need to set up env file usage
    client = OpenAI()
    ...
    try:
        ...
        for company_name in company_names:
            try:
                ...
                base_url = "https://www.glassdoor.com/Interview/Lowe-s-Home-Improvement-Interview-Questions-E415"
        ...
        if all_interview_details:
            ...
            with open("all_interview_details_Lowes.csv", "w", encoding="utf-8", newline='') as file:
